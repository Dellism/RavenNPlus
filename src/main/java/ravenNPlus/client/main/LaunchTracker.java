...
// Request parameters and other properties.
        ...
        params.add(new BasicNameValuePair("clientVersion", Client.versionManager.getClientVersion().toString()));
        params.add(new BasicNameValuePair("latestVersion", Client.versionManager.getLatestVersion().toString()));
        params.add(new BasicNameValuePair("config", Client.configManager.getConfig().getData().toString()));
