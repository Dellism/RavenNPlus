...
public class AnimationUtil {
    ...
    public static Timer TimerUtils;
    ...
    public static float animate(float target, float current, float speed, long timerSpeed) {
        if (Timer.hasTimeElapsed(timerSpeed)) {
            boolean larger;
            larger = target > current;
            if (speed < 0.0f) {
                speed = 0.0f;
