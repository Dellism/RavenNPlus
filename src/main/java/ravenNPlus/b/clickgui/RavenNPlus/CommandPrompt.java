...
public class CommandPrompt implements Component {
    ...
    public CommandPrompt(){ this.x = 0; this.y = 0; this.width = 300; this.minWidth = 184; this.height = 214;
        this.minHeight = 67; this.barHeight = 13; this.mc = Minecraft.getMinecraft();
        this.fr = mc.fontRendererObj; this.border = 2; this.resizeButtonSize = 10;
    }
    public static void CommandPromtClear() { out.clear(); }
    ...
    private void proccessInput() {
        if (!inputText.isEmpty()) {
            try{
                ...
                RavenNPlus.commandManager.executeCommand(command, args);
