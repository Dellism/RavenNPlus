...
public abstract class Command {
    ...
    public static void addChatMessage(String message) {
        net.minecraft.client.Minecraft.getMinecraft().thePlayer.addChatMessage(new net.minecraft.util.ChatComponentText("["+RavenNPlus.name+"] : " + message));
    }
