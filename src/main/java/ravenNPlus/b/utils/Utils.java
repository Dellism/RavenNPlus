...
public class Utils {
   ...
   public static class Player {
      ...
      public static void aim(Entity en, float pitchOffset, boolean pc, boolean silent) {
         if (en != null) {
   ...
   public static class URLS {
      ...
      public static final String base_paste = "{\"description\":"+RavenNPlus.name+" Config\",\"expiration\":\"never\",\"sections\":[{\"name\":\"TitleGoesHere\",\"syntax\":\"text\",\"contents\":\"BodyGoesHere\"}]}";
