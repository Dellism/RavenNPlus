...
import ravenNPlus.b.utils.Utils.Profiles.DuelsStatsMode;
import ravenNPlus.b.utils.profile.PlayerProfile;
import ravenNPlus.b.utils.profile.UUID;
        ...
        if (Utils.URLS.hypixelApiKey.isEmpty()) {
            ...
            RavenNPlus.getExecutor().execute(() -> {
                ...
                if(wlr > this.wlr.getInput() || playerProfile.winStreak > this.ws.getInput()) {
                    SumoBot sb = (SumoBot) RavenNPlus.moduleManager.getModuleByName("Sumo Bot");
                    sb.reQueue();
                }
            });
        }
