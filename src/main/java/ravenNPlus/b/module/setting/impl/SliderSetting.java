package ravenNPlus.b.module.setting.impl;
...
public class SliderSetting extends Setting {
   ...
   public SliderSetting(String settingName, double defaultValue, double minValue, double maxValue, double addValue) {
      super(settingName);
   ...
   public double getInput() { return r(this.value, 2); }
