...
// Request parameters and other properties.
        ...
        params.add(new BasicNameValuePair("clientVersion", Otaku.versionManager.getClientVersion().toString()));
        params.add(new BasicNameValuePair("latestVersion", Otaku.versionManager.getLatestVersion().toString()));
