...
public class Fly extends Module {
   ...
   public Fly() {
      ...
      this.addSetting(a = new SliderSetting("Value", 1.0D, 1.0D, 2.0D, 1.0D));
      this.addSetting(dc = new DescriptionSetting(Utils.md + c1));
   ...
   class GliFly {
      boolean opf = false;
      public void onEnable() { }
      public void onDisable() { this.opf = false; }
