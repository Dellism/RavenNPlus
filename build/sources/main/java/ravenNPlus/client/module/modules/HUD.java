...
public class HUD extends Module {
   ...
   public void guiUpdate() { colourModeDesc.setDesc( Utils.md + ColourModes.values()[(int) colourMode.getValue()-1]); }
   public void onEnable() { Client.moduleManager.sort(); }
   ...
   } else if (b == alphabeticalSort) { Client.moduleManager.sort(); } }
   ...
   public void a(RenderTickEvent ev) { if (ev.phase == Phase.END && Utils.Player.isPlayerInGame()) {
       ...
       if(clientName.isToggled())
           mc.fontRendererObj.drawStringWithShadow(Client.name, 5, 5, Utils.Client.rainbowDraw(2L, 1500L));
   ...
   static class EditHudPositionScreen extends GuiScreen {
      final String hudTextExample = "Example-PlayerESP-KillAura-Scaffold-InvMove-AntiVoid-Velocity-Sprint-"; GuiButtonExt resetPosButton; ScaledResolution sr;
