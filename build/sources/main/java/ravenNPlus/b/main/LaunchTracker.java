...
// Request parameters and other properties.
        ...
        params.add(new BasicNameValuePair("clientVersion", RavenNPlus.versionManager.getClientVersion().toString()));
        params.add(new BasicNameValuePair("latestVersion", RavenNPlus.versionManager.getLatestVersion().toString()));
        params.add(new BasicNameValuePair("config", RavenNPlus.configManager.getConfig().getData().toString()));
