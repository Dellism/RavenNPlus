...
import ravenNPlus.b.utils.version.VersionManager;
import ravenNPlus.b.clickgui.RavenNPlus.ClickGui;
import ravenNPlus.b.command.CommandManager;
import ravenNPlus.b.config.ConfigManager;
import ravenNPlus.b.module.Module;
import ravenNPlus.b.module.ModuleManager;
...
import static ravenNPlus.b.utils.Utils.mc;

public class RavenNPlus {
   ...
   public static String[] updateText = {"Your version of "+RavenNPlus.name+" ( " + versionManager.getClientVersion().toString() + " ) is outdated!"};
   ...
   public static ravenNPlus.b.utils.font.CustomFontrenderer customFontRenderer;
   ...
   public static void init() {
      ...
      MinecraftForge.EVENT_BUS.register(new RavenNPlus());
      ...
      RenderUtils.Notify(Type.OTHER, name, "Initialized", 5);
   }
