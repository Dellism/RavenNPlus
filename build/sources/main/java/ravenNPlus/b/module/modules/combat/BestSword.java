...
import ravenNPlus.b.utils.DelayTimer;
...
public class BestSword extends Module {
    ...
    public BestSword() {
        super("BestSword", ModuleCategory.combat, "Automatically puts the best weapon in slot 1");
        this.addSetting(AutoSet = new TickSetting("AutoSet", true));
    }
