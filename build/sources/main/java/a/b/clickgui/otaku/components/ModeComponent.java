...
import a.b.module.setting.impl.ComboSetting;
...
public class ModeComponent implements Component {
    ...
    public void update(int mousePosX, int mousePosY) { this.y = this.module.category.getY() + this.o; this.x = this.module.category.getX(); }

    public void setComponentStartAt(int n) { this.o = n; }
