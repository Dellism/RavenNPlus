...
import a.b.module.modules.player.RightClicker;
...
public class LeftClicker extends Module {
    ...
    private boolean allowedClick, watingForBreakTimeout, leftDown, leftn, breakHeld;
    ...
    public LeftClicker() {
        ...
        this.registerSetting(hitSelect = new TickSetting("HitSelect", false));
