...
import a.b.utils.Utils.Profiles.DuelsStatsMode;
import a.b.utils.profile.PlayerProfile;
import a.b.utils.profile.UUID;
...
public class SumoStats extends Module {
    ...
    public SumoStats() {
        super("Sumo Stats", ModuleCategory.minigames);
        ...
        if (Utils.URLS.hypixelApiKey.isEmpty()) {
            ...
            Otaku.getExecutor().execute(() -> {
                ...
                if(wlr > this.wlr.getInput() || playerProfile.winStreak > this.ws.getInput()) {
                    SumoBot sb = (SumoBot) Otaku.moduleManager.getModuleByName("Sumo Bot");
                    sb.reQueue();
                }
            });
        }
